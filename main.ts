...
function animeFound () {
    ...
    animation.attachAnimation(Acacio_G, heroIdGauche)
}
function Plan_de_niveau () {
    ...
    } else if (Niveau_actuel == 6) {
    	
    } else if (Niveau_actuel == 7) {
    	
    } else if (Niveau_actuel == 8) {
    	
    } else if (Niveau_actuel == 9) {
    	
    } else if (Niveau_actuel == 10) {
    	
    } else {
    	
    }
}
let heroIdGauche: animation.Animation = null
